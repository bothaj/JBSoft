...
{
    public class RequiredifManyRegexAttribute : ValidationAttribute
    {
        ...
        public RequiredifManyRegexAttribute(string dependentProperty, string [] targetValues, string checkValue)
        {
