...
namespace JBSoft.Dal
{
	...
	public static class PersonDb
	{
		...
		public static void Insert(ref Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
			...
			{
				connection.InfoMessage += InfoMessageHandler;
                using (SqlCommand cmd = BuildInsertCommand(id, firstName, surname, emailAddress, phoneHome, phoneMobile, phoneOffice, fax, description, gender, disability, disabilityNote, preferredName, statusId, user_Id))
				{
					cmd.Connection = connection;
					connection.Open();
					/*int rowsAffected = */cmd.ExecuteNonQuery();
		...
		///<param name="statusId"></param>
		///<param name="user_Id"></param>
		public static void Insert(string connectionString, ref Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
			if (connectionString == null)
				throw new ArgumentNullException("connectionString");
		...
		///<param name="statusId"></param>
		///<param name="user_Id"></param>
		public static void Insert(SqlTransaction transaction, ref Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
			if (transaction == null)
				throw new ArgumentNullException("transaction");
...
if (cmd.Parameters["@Id"].Value != DBNull.Value)
	id = (Guid?)cmd.Parameters["@Id"].Value;
        ...
        public static SqlDataReader SelectByName(string name)
		{
		...
		///<param name="connectionString">The connection string to be used to execute the stored procedure.</param>
		///<param name="name"></param>
        public static SqlDataReader SelectByName(string connectionString, string name)
		{
			if (connectionString == null)
				throw new ArgumentNullException("connectionString");
		...
		///<param name="statusId"></param>
		///<param name="user_Id"></param>
		public static void Update(Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
			if ((firstName != null) && (firstName.Length > 128))
            ...
            if ((fax != null) && (fax.Length > 20))
                throw new ArgumentException("Stored procedure TSP_Person_Update limits parameter @Fax to a maximum length of 20.", "fax");
			if ((description != null) && (description.Length > 256))
			...
			{
				connection.InfoMessage += InfoMessageHandler;
                using (SqlCommand cmd = BuildUpdateCommand(id, firstName, surname, emailAddress, phoneHome, phoneMobile, phoneOffice, fax, description, gender, disability, disabilityNote, preferredName, statusId, user_Id))
				{
					cmd.Connection = connection;
					connection.Open();
					/*int rowsAffected = */cmd.ExecuteNonQuery();
		...
		///<param name="statusId"></param>
		///<param name="user_Id"></param>
		public static void Update(string connectionString, Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
			if (connectionString == null)
				throw new ArgumentNullException("connectionString");
		...
		///<param name="statusId"></param>
		///<param name="user_Id"></param>
        public static void Update(SqlTransaction transaction, Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
			if (transaction == null)
				throw new ArgumentNullException("transaction");
		...
		///<param name="user_Id"></param>
		///<returns>A SqlCommand object with the parameters already bound.</returns>
		private static SqlCommand BuildInsertCommand(Guid? id,string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
            ...
            param = cmd.Parameters.Add("@Fax", SqlDbType.VarChar, 20);
            param.Value = fax;
		...
		///<param name="user_Id"></param>
		///<returns>A SqlCommand object with the parameters already bound.</returns>
		private static SqlCommand BuildUpdateCommand(Guid? id, string firstName, string surname, string emailAddress, string phoneHome, string phoneMobile, string phoneOffice, string fax, string description, int? gender, bool? disability, string disabilityNote, string preferredName, int? statusId, Guid? user_Id)
		{
