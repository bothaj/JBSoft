...
{
	///<summary>
	///A generated Data Access Layer class containing all stored procedures matching the pattern sp_FeatureSection*.
	///</summary>
	public static class FeatureSectionDb
	{
		...
		public static void Insert(Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
			if ((imageUrl != null) && (imageUrl.Length > 250))
				throw new ArgumentException("Stored procedure sp_FeatureSection_Insert limits parameter @ImageUrl to a maximum length of 250.", "imageUrl");
			string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["default"].ConnectionString;
			using (SqlConnection connection = new SqlConnection(connectionString))
			{
				connection.InfoMessage += InfoMessageHandler;
				using (SqlCommand cmd = Build_InsertCommand(id, description_Id, imageUrl, sortOrder, statusId))
				{
					cmd.Connection = connection;
					connection.Open();
					/*int rowsAffected = */cmd.ExecuteNonQuery();
		...
		///<param name="sortOrder">The SortOrder of FeatureSection</param>
		///<param name="statusId">The StatusId of FeatureSection</param>
		public static void Insert(string connectionString, Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
			if (connectionString == null)
				throw new ArgumentNullException("connectionString");
		...
		///<param name="sortOrder">The SortOrder of FeatureSection</param>
		///<param name="statusId">The StatusId of FeatureSection</param>
		public static void Insert(SqlTransaction transaction, Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
			if (transaction == null)
				throw new ArgumentNullException("transaction");
		...
		public static void Update(Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
			if ((imageUrl != null) && (imageUrl.Length > 250))
				throw new ArgumentException("Stored procedure sp_FeatureSection_Update limits parameter @ImageUrl to a maximum length of 250.", "imageUrl");
			string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["default"].ConnectionString;
			using (SqlConnection connection = new SqlConnection(connectionString))
			{
				connection.InfoMessage += InfoMessageHandler;
				using (SqlCommand cmd = Build_UpdateCommand(id, description_Id, imageUrl, sortOrder, statusId))
				{
					cmd.Connection = connection;
					connection.Open();
					/*int rowsAffected = */cmd.ExecuteNonQuery();
		...
		///<param name="sortOrder">The sort order.</param>
		///<param name="statusId"></param>
		public static void Update(string connectionString, Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
			if (connectionString == null)
				throw new ArgumentNullException("connectionString");
		...
		///<param name="sortOrder">The sort order.</param>
		///<param name="statusId"></param>
		public static void Update(SqlTransaction transaction, Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
			if (transaction == null)
				throw new ArgumentNullException("transaction");
		...
		///<param name="statusId">The StatusId of FeatureSection</param>
		///<returns>A SqlCommand object with the parameters already bound.</returns>
		private static SqlCommand Build_InsertCommand(Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
		...
		///<param name="statusId"></param>
		///<returns>A SqlCommand object with the parameters already bound.</returns>
		private static SqlCommand Build_UpdateCommand(Guid? id, Guid? description_Id, string imageUrl, int? sortOrder, int? statusId)
		{
		...
		{
			System.Diagnostics.Trace.WriteLine(e.ToString(), string.Format("{0}[{1}]", typeof(FeatureSectionDb).FullName, e.Errors[0].Procedure));
		}
