...
namespace JBSoft.Utils
{
    ...
    public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue>
    {
        ...
        [NonSerialized] private static readonly string _keyTypeName = typeof(TKey).FullName;
        [NonSerialized] private static readonly string _valueTypeName = typeof(TValue).FullName;
        [NonSerialized] private static readonly bool _valueTypeIsReferenceType = !typeof(ValueType).IsAssignableFrom(typeof(TValue));

		private Dictionary<TKey, DictionaryItem> _dictionary;
        ...
        {
            Dictionary.Add(key, new DictionaryItem() { item = value, index = Count });
        ...
        public void Insert(int index, TKey key, TValue value)
        {
            ...
            Dictionary.Add(key, new DictionaryItem() { item = value, index = index });
        ...
        public TValue this[int index]
        {
            ...
            set
            {
                ...
                Dictionary[key] = new DictionaryItem() { item = value, index = index };
            }
        }

        /// <summary>
        /// Returns values of the dictionary in the case of the key being an integer
        /// </summary>
        public TValue GetValue(TKey key)
        {
            return this.Dictionary[key].item;
        }
        ...
        {
            DictionaryItem temp;
            bool containsValue = Dictionary.TryGetValue(key, out temp);
        ...
        public int IndexOfKey(TKey key)
        {
            ...
            //    }
            //}
            DictionaryItem indexOfItem;

            if (Dictionary.TryGetValue(key, out indexOfItem))
        ...
        public TValue this[TKey key]
        {
            ...
            set
            {
                ...
                {
                    var dictionaryItem = Dictionary[key];
                    dictionaryItem.item = value;

                    Dictionary[key] = dictionaryItem;
        ...
        private Dictionary<TKey, DictionaryItem> Dictionary
        {
            get
            {
                if (null == _dictionary)
                {
                    _dictionary = new Dictionary<TKey, DictionaryItem>(_initialCapacity, _comparer);
                }
        ...
        /// <summary>
        /// Compound object used to stored the values position in the list.
        /// Done to make finding elements via index easier.
        /// </summary>        
        [Serializable]
